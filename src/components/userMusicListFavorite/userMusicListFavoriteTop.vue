    ...
    <div class="infosContent" id="infosContent">
      <div class="infos">
        <div class="infosPic">
          ...
          <el-image class="img" :src="playlist.coverImgUrl" :preview-src-list="[playlist.coverImgUrl]" fit="cover"></el-image>
        </div>
        <div class="infosText">
...
import {Star,Download,VideoCamera,StarFilled,Back,Search,MoreFilled,ArrowRight,ArrowDownBold,VideoPlay,CirclePlus,ChatLineRound,Share,Edit} from '@element-plus/icons-vue'
import {downloadMusic, getMv} from "../../request/api/musicList.js";
import {addMusicToList, createMusicList, getMusicListSongAll} from '../../request/api/userMusicList.js'
